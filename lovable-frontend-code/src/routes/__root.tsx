...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "TradePilot — AI Powered Paper Trading" },
      { name: "description", content: "Learn stock market trading safely with virtual money, real-time data, and AI-powered insights." },
    ],
    links: [
